package com.finledger.account.config;

import com.finledger.account.security.JwtAuthenticationFilter;
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http, JwtService jwtService,
        ...
        return http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/accounts/*/debit", "/accounts/*/credit", "/accounts/*/holds", "/accounts/*/holds/*/settle", "/accounts/*/holds/*/release").hasRole("SERVICE")
